...
internal class Api31BluetoothPermissionChecker(private val context: Context) :
    ...
    private fun checkPermissions(permissionsToCheck: List<String>): PermissionCheckerResult {
