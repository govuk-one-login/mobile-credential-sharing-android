...
@ContributesBinding(scope = AppScope::class, binding = binding<EncryptDeviceResponseUseCase>())
class EncryptDeviceResponseUseCaseImpl(
    private val sessionSecurity: SessionSecurity,
    private val logger: Logger
) : EncryptDeviceResponseUseCase {
